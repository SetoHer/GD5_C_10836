package com.example.gdroom_c_10836
...
import com.example.gdroom_c_10836.room.Constant
import com.example.gdroom_c_10836.room.Note
import com.example.gdroom_c_10836.room.NoteDB
...
class MainActivity : AppCompatActivity() {
    ...
    private fun deleteDialog(note: Note){
        ...
        alertDialog.apply {
            ...
            setMessage("Are You Sure to delete this data Fro ${note.title}?")
